...
my $uber_editor= "pluma"; # Example linux editor for Friends/trigger textfiles
##################################
...
my $uber_path=Xchat::get_info('xchatdir') . '/plugins/Uberscript/'; # Windows is just as happy with / as linux is.
