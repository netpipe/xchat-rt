...
my %SETTINGS = (
	"configfile" => IRC::get_info(4)."/plugins/away/away.conf",
	"xchatconf" => IRC::get_info(4)."/plugins/away/xchat.conf",
	"defaultappend" => "away",
	...
	"hideawayfile" => IRC::get_info(4)."/plugins/away/hideaway.conf",
	"reasonlistitem" => '%r [%t]',
	"silentaway" => 0,
	"eatnick" => 1,
	"lockednick" => 0,
